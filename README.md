[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=22&pause=1000&color=FFFFFF&width=435&lines=Bienvenue+!+)](https://git.io/typing-svg)


# Salut, moi c'est Emerik ! 👋

### 🚀 Passionné par l'informatique

C'est ici que je partage mes expérimentations, mes projets terminés (et ceux qui ne le seront probablement jamais). Je crois fermement que le code est une forme d'art, mais avec plus de points-virgules.
